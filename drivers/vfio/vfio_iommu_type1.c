			    ...
			    size_t map_size)
{
	...
	while (size) {
		...
		//	printk("line 1556\n");
			...
			//here instead of lookup_page_ext() function need to use page_ext_get() as some rcu lock is taken gracefully
			//also if we have page rxt we need to call page_ext_put()
			if(page_ext != NULL)
			{
